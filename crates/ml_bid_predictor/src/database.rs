    ...
    pub async fn get_tender_by_resource_id(&self, resource_id: &str) -> Result<Option<crate::types::TenderRecord>> {
        let query = r#"
            SELECT 
                ...
                estimated_value,
                description,
                COALESCE(code_33000000, false) as code_33000000,
                COALESCE(code_48000000, false) as code_48000000,
                COALESCE(code_72000000, false) as code_72000000,
                COALESCE(code_79000000, false) as code_79000000,
                COALESCE(code_80000000, false) as code_80000000,
                COALESCE(code_85000000, false) as code_85000000,
                COALESCE(code_90000000, false) as code_90000000,
                COALESCE(code_92000000, false) as code_92000000,
                pdf_url,
                source,
                bid,
                ml_bid,
        ...
        if let Some(row) = row {
            Ok(Some(crate::types::TenderRecord {
                ...
                code_33000000: Some(row.get("code_33000000")),
                code_48000000: Some(row.get("code_48000000")),
                code_72000000: Some(row.get("code_72000000")),
                code_79000000: Some(row.get("code_79000000")),
                code_80000000: Some(row.get("code_80000000")),
                code_85000000: Some(row.get("code_85000000")),
                code_90000000: Some(row.get("code_90000000")),
                code_92000000: Some(row.get("code_92000000")),
